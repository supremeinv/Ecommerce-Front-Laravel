        ...
        <div class="media wow fadeInUp" data-wow-duration="1s"> 
            ...
            <div class="media-body">
                ...
                <div class="container">
                    ...
                    <div class="row">                        
                        <div class="col-xs-12 col-md-12" style="background: none; border-radius: 5px; padding: 10px;">
                            <div class="panel panel-primary">                                       
                                <div class="creditCardForm">                                    
                                    <div class="payment">
                                        <form id="payment-card-info" method="post" action="{{ route('payment.process') }}">
                                            @csrf
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-4" >
                                                    ...
                                                    <input type="number" class="form-control" id="amount" name="amount" min="1" value="{{$amount}}" required>
                                            ...
                                            <div class="form-group" id="pay-now">
                                                <button type="submit" class="common-btn shop-details-review-btn update-cart-content-btn" id="confirm-purchase">Confirm Payment</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>                                
